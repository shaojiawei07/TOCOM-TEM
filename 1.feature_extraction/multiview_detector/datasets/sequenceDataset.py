...
class sequenceDataset(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        frame_name = list(self.map_gt.keys())[index]
        ...
        for i in range(self.tau + 1):
            ...
            sequence_maps_gt.append(map_gt.unsqueeze(0))

        sequence_imgs = torch.cat(sequence_imgs, dim = 0)
        sequence_maps_gt = torch.cat(sequence_maps_gt, dim = 0)


        return sequence_imgs, sequence_maps_gt, frame_name
